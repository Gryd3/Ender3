...
#define STRING_CONFIG_H_AUTHOR "(Gryd3, E3Pro 422 Marlin 2.1.2)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 Pro 422"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "b6439ff6-4e3b-4c8a-a257-95ee988937d8"
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 16.70f }           // (J/K) Heat block heat capacities.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.28, 80.17, 400, 93 }
...
#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 600, 600, 100, 200 } // ...or, set your own edit limits
#endif
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1200, 1200, 200, 1000 }

#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
#if ENABLED(LIMITED_MAX_ACCEL_EDITING)
  #define MAX_ACCEL_EDIT_VALUES       { 12000, 12000, 2000, 10000 } // ...or, set your own edit limits
#endif
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.010 // (mm) Distance from real junction edge - Using 0.01 - 0.036
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -48, -6, -0.89 }
...
#define SKEW_CORRECTION
  ...
  #define XY_DIAG_AC 140.83 //282.8427124746
  #define XY_DIAG_BD 141.81 //282.8427124746
