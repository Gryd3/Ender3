...
#define STRING_CONFIG_H_AUTHOR "(Gryd3, E3Neo 422 Marlin 2.1.2)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 Neo 422"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "a281a4b5-f194-4595-9d02-457f4e244b7f"
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 13.50f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.3238f }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.1225f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.1318f }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.10, 79.90, 400, 95.50 }
...
#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 6000, 6000, 50, 250 } // ...or, set your own edit limits
#endif
...
#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
  ...
  #define MAX_ACCEL_EDIT_VALUES       { 60000, 60000, 2000, 20000 } // ...or, set your own edit limits
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -35.5, -1, -2.19 }
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_USE_PROBE
    ...
    #define BED_TRAMMING_PROBE_TOLERANCE 0.07  // (mm)
...
#define SKEW_CORRECTION
  ...
  #define XY_DIAG_AC 140.59 //282.8427124746
  #define XY_DIAG_BD 141.63 //282.8427124746
  #define XY_SIDE_AD 100 //200
 ...
 */
// Gryd3 . Do I disable this in favor of GCode start/end scripts?
